...
const NewReminder = ({
    ...
    const handleCreateEntry = ()=>{
        ...
        navigation.goBack();
        Keyboard.dismiss();
        ToastAndroid.show("Reminder successfully created!", ToastAndroid.SHORT);
    }
    ...
    return <ColorContainer>
        ...
        <View style={styles.Footer}>
            <SolidButton disabled={!areValuesValid()} onPress={handleCreateEntry}> <Text>Create Reminder</Text></SolidButton>
        </View>
    </ColorContainer>
}
